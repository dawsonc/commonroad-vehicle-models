...
def test_zeroInitialVelocity():
    ...
    x_dec_gt = [
        ...
        -0.0016872664171374,
        -0.0012652511246015,
    ]  # ground truth for multi-body model
    x_dec_st_gt = [
        -3.4335000000000013,
        0.0000000000000000,
        0.0000000000000000,
    ...
    res.append(
        all(abs(x_dec_st[-1] - x_dec_st_gt) < 1e-2)
    )  # -1 refers to last time step
    res.append(
        all(abs(x_dec_ks[-1] - x_dec_ks_gt) < 1e-2)
    )  # -1 refers to last time step
    print(res)
    ...
    res.append(
        all(abs(x_acc_st[-1] - x_acc_st_gt) < 1e-2)
    )  # -1 refers to last time step
    res.append(
        all(abs(x_acc_ks[-1] - x_acc_ks_gt) < 1e-2)
    )  # -1 refers to last time step
    print(res)
    ...
    res.append(
        all(abs(x_left_st[-1] - x_left_st_gt) < 1e-2)
    )  # -1 refers to last time step
    res.append(
        all(abs(x_left_ks[-1] - x_left_ks_gt) < 1e-2)
    )  # -1 refers to last time step
    print(res)
    print(x_left[-1])
    print(x_left[0])
